...
<content tag="page-body">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div id="top-menu" class="modal aside" data-fixed="true"
				data-placement="top" data-background="true"
				...
				<div class="modal-dialog">
						...
						<div class="modal-body container">
							<div class="row">
								...
								<div class="col-sm-5 text-center line-height-2">
									<a class="btn btn-app btn-Default no-radius" href="#"> <i
										class="ace-icon fa fa-pencil-square-o bigger-230"></i>
										Default <span
										class="label label-light arrowed-in-right badge-left">11</span>
									</a> &nbsp; &nbsp; <a class="btn btn-info btn-app no-radius"
										href="#"> <i class="ace-icon fa fa-cog bigger-230"></i>
										Mailbox <span class="label label-danger arrowed-in">6+</span>
									</a> &nbsp; &nbsp; <a class="btn btn-app btn-light no-radius"
										href="#"> <i class="ace-icon fa fa-print bigger-230"></i>
										Print
									</a>
								</div>
							</div>
					...
					<button
						class="btn btn-inverse btn-app btn-xs ace-settings-btn aside-trigger"
			...
			<div id="bottom-menu" class="modal aside" data-fixed="true"
				data-placement="bottom" data-background="true" tabindex="-1">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-body container">
							<div class="row">
					...
					<button
						class="btn btn-yellow btn-app btn-xs ace-settings-btn aside-trigger"
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<br /> With no modal backdrop <br /> <br /> <br /> <br /> <br />
							<br /> <br /> <br /> <br /> <br /> <br /> <br /> <br />
							<br /> <br /> 1 <br /> <br /> <br /> <br /> <br /> <br />
							<br /> <br /> <br /> <br /> <br /> <br /> <br /> <br />
			...
			<a href="#my-modal" role="button"
				class="bigger-125 bg-primary white" data-toggle="modal"> &nbsp;
			...
			<div id="aside-inside-modal" class="modal" data-placement="bottom"
				...
				<div class="modal-dialog">
					...
					<button
						...
						data-target="#aside-inside-modal" data-toggle="modal"
						type="button">
