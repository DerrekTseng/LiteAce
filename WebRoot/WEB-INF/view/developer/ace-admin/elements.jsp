	...
	*/
	...
	$('#gritter-regular').on(ace.click_event, function(){
		$.gritter.add({
			...
			image: "<c:url value='/resource/assets/images/avatars/avatar1.png' />", //in Ace demo ./dist will be replaced by correct assets path
			sticky: false,
			time: '',
	...
	$('#gritter-sticky').on(ace.click_event, function(){
		var unique_id = $.gritter.add({
			...
			image: "<c:url value='/resource/assets/images/avatars/avatar.png' />",
			sticky: true,
			time: '',
	...
	$('#gritter-max3').on(ace.click_event, function(){
		$.gritter.add({
			...
			image: "<c:url value='/resource/assets/images/avatars/avatar3.png' />", //in Ace demo ./dist will be replaced by correct assets path
			sticky: false,
...
<content tag="page-header">
	<h1>
		UI Elements <small> <i
			class="ace-icon fa fa-angle-double-right"></i> Common UI Features
			&amp; Elements
		</small>
	</h1>
</content>
	...
	<div class="row">
		<div class="col-xs-12">
				...
				<div class="col-sm-6">
					<div class="tabbable">
						<ul class="nav nav-tabs" id="myTab">
							...
							<li><a data-toggle="tab" href="#messages"> Messages <span
					...
					<div class="tabbable tabs-left">
						<ul class="nav nav-tabs" id="myTab3">
							...
							<li><a data-toggle="tab" href="#profile3"> <i
									class="blue ace-icon fa fa-user bigger-110"></i> Profile
							</a></li>

							<li><a data-toggle="tab" href="#dropdown13"> <i
									class="ace-icon fa fa-rocket"></i> More
							</a></li>
						</ul>
							...
							<div class="panel-heading">
								<h4 class="panel-title">
									<a class="accordion-toggle" data-toggle="collapse"
										...
										data-icon-show="ace-icon fa fa-angle-right"></i> &nbsp;Group
										Item #1
									</a>
								</h4>
							</div>
						...
						<div class="widget-body">
							<div class="widget-main">
								<p>
									...
									<span class="btn btn-success btn-sm popover-success"
									...
									<span class="btn btn-warning btn-sm popover-warning"
								...
								<p>
									<span class="btn btn-danger btn-sm popover-error"
									...
									<span class="btn btn-info btn-sm popover-info"
			...
			<div class="row">
				<div class="col-sm-6">
					<h3 class="header smaller lighter green">
						<i class="ace-icon fa fa-bullhorn"></i> Alerts
					</h3>
				...
				<div class="col-sm-6">
					<h3 class="row header smaller lighter orange">
						<span class="col-sm-8"> <i class="ace-icon fa fa-bell"></i>
					...
					<div class="row">
						...
						<div class="col-xs-12">
							...
							<form class="form-horizontal" id="spinner-opts">
								<label class="inline"> <small class="lighter">Lines:</small>

									<input class="hidden" type="text" name="lines" data-min="5"
									data-max="16" data-step="2" value="12" />
								</label>

								<div class="space-0"></div>

								<label class="inline"> <small class="lighter">Length:</small>

									<input class="hidden" type="text" name="length" data-min="0"
									data-max="30" value="7" />
								</label>

								<div class="space-0"></div>

								<label class="inline"> <small class="lighter">Width:</small>

									<input class="hidden" type="text" name="width" data-min="2"
									data-max="20" value="4" />
								</label>

								<div class="space-0"></div>

								<label class="inline"> <small class="lighter">Radius:</small>

									<input class="hidden" type="text" name="radius" data-min="0"
									data-max="40" value="10" />
								</label>

								<div class="space-0"></div>

								<label class="inline"> <small class="lighter">Corners:</small>

									<input class="hidden" type="text" name="corners" data-min="0"
									data-max="1" data-step="0.1" value="1" />
								</label>

								<div class="space-0"></div>

								<label class="inline"> <small class="lighter">Rotate:</small>

									<input class="hidden" type="text" name="rotate" data-min="0"
									data-max="90" value="0" />
								</label>

								<div class="space-0"></div>

								<label class="inline"> <small class="lighter">Trail:</small>

									<input class="hidden" type="text" name="trail" data-min="10"
									data-max="100" value="60" />
								</label>

								<div class="space-0"></div>

								<label class="inline"> <small class="lighter">Speed:</small>

									<input class="hidden" type="text" name="speed" data-min="0.5"
			...
			<div class="row">
				<div class="col-sm-6">
						...
						<ul class="dropdown-menu dropdown-danger">
							...
							<li class="dropdown-hover"><a href="#" tabindex="-1"
								class="clearfix"> <span class="pull-left">More
										options</span> <i class="ace-icon fa fa-caret-right pull-right"></i>
							</a>
					...
					<div class="dropup dropdown-preview">
						<ul class="dropdown-menu dropdown-light">
							...
							<li class="dropup dropdown-hover"><a href="#" tabindex="-1"
								class="clearfix"> <span class="pull-left">More
										options</span> <i class="ace-icon fa fa-caret-right pull-right"></i>
							</a>
					...
					<div class="dropup dropdown-preview">
						<ul class="dropdown-menu dropdown-purple">
							...
							<li class="dropdown-hover dropup"><a href="#" tabindex="-1"
								class="clearfix"> <span class="pull-left">More
										options</span> <i class="ace-icon fa fa-caret-left pull-right"></i>
							</a>
					...
					<div class="dropdown dropdown-preview">
						<ul
							class="dropdown-menu dropdown-icon-only dropdown-50 dropdown-light">
							<li class="action-buttons"><a href="#" tabindex="-1"
								class="center"> <i class="fa fa-flag blue bigger-130"></i>
							</a></li>

							<li class="action-buttons"><a href="#" tabindex="-1"
								class="center"> <i class="fa fa-flag red bigger-130"></i>
							</a></li>

							<li class="action-buttons"><a href="#" tabindex="-1"
								class="center"> <i class="fa fa-flag green bigger-130"></i>
							</a></li>

							<li class="action-buttons"><a href="#" tabindex="-1"
								class="center"> <i class="fa fa-flag orange bigger-130"></i>
							</a></li>
						</ul>
					</div>
				</div>
				...
				<div class="col-sm-6">
					<h3 class="row header smaller lighter blue">
						<span class="col-sm-7"> <i class="ace-icon fa fa-th-large"></i>
							Pills
						</span>
						<!-- /.col -->
						...
						<span class="col-sm-5"> <label class="pull-right inline">
								...
								id="id-pills-stacked" type="checkbox"
