		...
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form">
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-top"> Star
						Rating </label>
				...
				<div class="form-group">
					<label class="control-label col-xs-12 col-sm-3 no-padding-right"
						for="food">Bootstrap Multiselect</label>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-top"
						for="duallist"> Dual listbox </label>
				...
				<div class="form-group">
					...
					<div class="col-xs-12 col-sm-9">
						<select multiple id="state" name="state" class="select2"
						...
						</select> <span class="inline pull-right"> <span class="grey">style:</span>
