										...
										<div>
											<div class="messagebar-item-left">
												<label class="inline middle"> <input
													type="checkbox" id="id-toggle-all" class="ace" /> <span
													class="lbl"></span>
												</label> &nbsp;
										...
										<div class="message-list" id="message-list">
											<div class="message-item message-unread">
												<label class="inline"> <input type="checkbox"
													...
													class="sender" title="Alex John Red Smith">Alex
													John Red Smith </span> <span class="time">1:33 pm</span> <span
													class="summary"> <span class="text"> Click
														to open this message </span>
												</span>
											</div>
											...
											<div class="message-item message-unread">
												...
												<span class="sender" title="John Doe"> John Doe <span
													...
													class="text"> Clik to open this message right here
												</span>
												</span>
											</div>
											...
											<div class="message-item">
												...
												<span class="time">April 4</span> <span class="summary">
											...
											<div class="message-item">
												...
												<span class="time">April 3</span> <span class="summary">
													<span class="badge badge-grey mail-tag"></span> <span
				...
				<div>
					...
					<div class="align-right">
						<button id="id-add-attachment" type="button"
							...
							<i class="ace-icon fa fa-paperclip bigger-140"></i> Add
							Attachment
						</button>
					</div>
