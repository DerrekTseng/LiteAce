...
<content tag="page-header">
	<h1>
		Pricing Tables <small> <i
			class="ace-icon fa fa-angle-double-right"></i> Large &amp; Small
		</small>
	</h1>
</content>
						...
						<div class="widget-body">
							<div class="widget-main">
								<ul class="list-unstyled spaced2">
									<li><i class="ace-icon fa fa-check green"></i> 10 GB Disk
										Space</li>

									<li><i class="ace-icon fa fa-check green"></i> 200 GB
										Bandwidth</li>

									<li><i class="ace-icon fa fa-check green"></i> 100 Email
										Accounts</li>

									<li><i class="ace-icon fa fa-check green"></i> 10 MySQL
										Databases</li>

									<li><i class="ace-icon fa fa-check green"></i> $10 Ad
										Credit</li>

									<li><i class="ace-icon fa fa-times red"></i> Free Domain
									</li>
								</ul>
				...
				<div class="col-xs-6 col-sm-3 pricing-box">
					<div class="widget-box widget-color-orange">
						...
						<div class="widget-body">
							<div class="widget-main">
								<ul class="list-unstyled spaced2">
									<li><i class="ace-icon fa fa-check green"></i> 50 GB Disk
										Space</li>

									<li><i class="ace-icon fa fa-check green"></i> 1 TB
										Bandwidth</li>

									<li><i class="ace-icon fa fa-check green"></i> 1000 Email
										Accounts</li>

									<li><i class="ace-icon fa fa-check green"></i> 100 MySQL
										Databases</li>
						...
						<div class="widget-body">
							<div class="widget-main">
								<ul class="list-unstyled spaced2">
									...
									<li><i class="ace-icon fa fa-check green"></i> Unlimited
										Bandwidth</li>

									<li><i class="ace-icon fa fa-check green"></i> 1000 Email
										Accounts</li>

									<li><i class="ace-icon fa fa-check green"></i> 200 MySQL
										Databases</li>
						...
						<div class="widget-body">
							<div class="widget-main">
								<ul class="list-unstyled spaced2">
									...
									<li><i class="ace-icon fa fa-check green"></i> $50 Ad
										Credit</li>

									<li><i class="ace-icon fa fa-check green"></i> 2 Free
										Domains</li>
								</ul>
							...
							<div class="widget-body">
								<div class="widget-main no-padding">
									<ul class="list-unstyled list-striped pricing-table">
										...
										<li><i class="ace-icon fa fa-check green"></i> 1</li>
									</ul>
							...
							<div class="widget-body">
								<div class="widget-main no-padding">
									<ul class="list-unstyled list-striped pricing-table">
										...
										<li><i class="ace-icon fa fa-check green"></i> 2</li>
									</ul>
							...
							<div class="widget-body">
								<div class="widget-main no-padding">
									<ul class="list-unstyled list-striped pricing-table">
										...
										<li><i class="ace-icon fa fa-check green"></i> 3</li>
									</ul>
