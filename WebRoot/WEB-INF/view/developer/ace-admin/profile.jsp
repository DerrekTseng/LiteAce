...
<content tag="page-header">
	<h1>
		User Profile Page <small> <i
			class="ace-icon fa fa-angle-double-right"></i> 3 styles with inline
			editable feature
		</small>
	</h1>
</content>
...
<content tag="page-body">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="clearfix">
				<div
					class="pull-left alert alert-success no-margin alert-dismissable">
					...
					<div class="col-xs-12 col-sm-3 center">
						<div>
							<span class="profile-picture"> <img id="avatar"
								...
								src="<c:url value='/resource/assets/images/avatars/profile-pic.jpg' />" />
							</span>
						...
						<div class="profile-contact-info">
							<div class="profile-contact-links align-left">
								<a href="#" class="btn btn-link"> <i
									class="ace-icon fa fa-plus-circle bigger-120 green"></i> Add
									as a friend
									...
									<div id="profile-feed-1" class="profile-feed">
										<div class="profile-activity clearfix">
											<div>
												<img class="pull-left" alt="Alex Doe's avatar"
													src="<c:url value='/resource/assets/images/avatars/avatar5.png' />" />
												<a class="user" href="#"> Alex Doe </a> changed his profile
												photo. <a href="#">Take a look</a>

												<div class="time">
													<i class="ace-icon fa fa-clock-o bigger-110"></i> an hour
													ago
												</div>
											</div>
										...
										<div class="profile-activity clearfix">
											<div>
												<img class="pull-left" alt="Susan Smith's avatar"
													src="<c:url value='/resource/assets/images/avatars/avatar1.png' />" />
												<a class="user" href="#"> Susan Smith </a> is now friends
												with Alex Doe.
												<div class="time">
													<i class="ace-icon fa fa-clock-o bigger-110"></i> 2 hours
													ago
												</div>
											</div>
										...
										<div class="profile-activity clearfix">
											<div>
												...
												<a class="user" href="#"> Alex Doe </a> joined <a href="#">Country
													Music</a> group.
												<div class="time">
													<i class="ace-icon fa fa-clock-o bigger-110"></i> 5 hours
													ago
												</div>
											</div>
										...
										<div class="profile-activity clearfix">
											<div>
												<img class="pull-left" alt="David Palms's avatar"
													src="<c:url value='/resource/assets/images/avatars/avatar4.png' />" />
												<a class="user" href="#"> David Palms </a> left a comment
												on Alex's wall.
												<div class="time">
													<i class="ace-icon fa fa-clock-o bigger-110"></i> 8 hours
													ago
												</div>
											</div>
										...
										<div class="profile-activity clearfix">
											<div>
												<img class="pull-left" alt="Alex Doe's avatar"
													src="<c:url value='/resource/assets/images/avatars/avatar5.png' />" />
												<a class="user" href="#"> Alex Doe </a> upgraded his
												skills.
												<div class="time">
						...
						<div class="tab-content no-border padding-24">
							...
							<div id="friends" class="tab-pane">
								<div class="profile-users clearfix">
									...
									<div class="itemdiv memberdiv">
										<div class="inline pos-rel">
											<div class="user">
												<a href="#"> <img
													src="<c:url value='/resource/assets/images/avatars/avatar.png' />"
									...
									<div class="itemdiv memberdiv">
										<div class="inline pos-rel">
											<div class="user">
												<a href="#"> <img
													src="<c:url value='/resource/assets/images/avatars/avatar2.png' />"
									...
									<div class="itemdiv memberdiv">
										<div class="inline pos-rel">
											<div class="user">
												<a href="#"> <img
													src="<c:url value='/resource/assets/images/avatars/avatar3.png' />"
								...
								<ul class="pager pull-right">
									<li class="previous disabled"><a href="#">&larr; Prev</a>
									</li>
