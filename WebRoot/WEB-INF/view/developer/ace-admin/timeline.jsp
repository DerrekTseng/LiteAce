...
<content tag="page-header">
	<h1>
		Timeline <small> <i class="ace-icon fa fa-angle-double-right"></i>
								...
								<div class="timeline-item clearfix">
									<div class="timeline-info">
										<img alt="Susan't Avatar"
											src="<c:url value='/resource/assets/images/avatars/avatar1.png' />" /> <span
												...
												<div class="clearfix">
													...
													<div class="pull-right">
														...
														&nbsp; <img alt="Image 4" width="36"
															src="<c:url value='/resource/assets/images/gallery/thumb-4.jpg' />" /> <img
															alt="Image 3" width="36"
															src="<c:url value='/resource/assets/images/gallery/thumb-3.jpg' />" /> <img
															alt="Image 2" width="36"
															src="<c:url value='/resource/assets/images/gallery/thumb-2.jpg' />" /> <img
															alt="Image 1" width="36"
															src="<c:url value='/resource/assets/images/gallery/thumb-1.jpg' />" /> &nbsp; <i
									...
									<div class="widget-box transparent">
										<div class="widget-body">
											<div class="widget-main no-padding">
												<div class="clearfix">
													<div class="pull-left">
														<span class="orange2 bolder">Haloween party</span> Lots
														of fun at Haloween party. <br /> Take a look at some
														pics:
													</div>
