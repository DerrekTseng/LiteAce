...
<content tag="page-header">
	<h1>
		Typography <small> <i
			class="ace-icon fa fa-angle-double-right"></i> This is page-header
			(.page-header &gt; h1)
		</small>
	</h1>
</content>
									...
									<div class="col-xs-12">
										<ul class="list-unstyled spaced">
											<li><i class="ace-icon fa fa-bell-o bigger-110 purple"></i>
												List with custom icons and more space</li>

											<li><i class="ace-icon fa fa-check bigger-110 green"></i>
												Unordered List Item # 2</li>
										...
										<ul class="list-unstyled spaced2">
											<li><i class="ace-icon fa fa-circle green"></i> Even
												more space</li>

											<li class="text-warning bigger-110 orange"><i
												class="ace-icon fa fa-exclamation-triangle"></i> Unordered
												List Item # 5</li>
											...
											<li>
												<ul class="list-inline">
													<li><i class="ace-icon fa fa-share green bigger-110"></i>
					...
					<div class="widget-box">
						<div class="widget-header widget-header-flat">
							<h4 class="widget-title smaller">
								<i class="ace-icon fa fa-quote-left smaller-80"></i> BlockQuote
								& Address
							</h4>
						</div>
						...
						<div class="widget-body">
							<div class="widget-main">
								...
								<div class="row">
									<div class="col-xs-12">
										<blockquote>
											<p class="lighter line-height-125">Lorem ipsum dolor sit
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="widget-box">
								<div class="widget-header widget-header-flat">
									<h4 class="smaller">
										<i class="ace-icon fa fa-code"></i> Code view
									</h4>
								</div>
