...
<content tag="page-header">
	<h1>
		Widgets <small> <i class="ace-icon fa fa-angle-double-right"></i>
						...
						<div class="widget-box widget-color-blue" id="widget-box-2">
							<div class="widget-header">
								<h5 class="widget-title bigger lighter">
									<i class="ace-icon fa fa-table"></i> Tables
									<% out.print("&"); %>
									Colors
								</h5>
						...
						<div class="widget-box widget-color-orange collapsed"
							...
							<div class="widget-header widget-header-small">
								<h6 class="widget-title">
									<i class="ace-icon fa fa-sort"></i> Small Header
									<% out.print("&"); %>
									Collapsed
								</h6>
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-6 widget-container-col"
						...
						<div class="widget-box widget-color-dark" id="widget-box-7">
							<div class="widget-header widget-header-small">
								...
								<div class="widget-toolbar no-border">
									<label> <input type="checkbox"
										class="ace ace-switch ace-switch-3" /> <span
								...
								<div class="widget-toolbar">
									<span class="label label-warning"> 1.2% <i
										class="ace-icon fa fa-arrow-down"></i>
							...
							<div class="widget-body">
								<div class="widget-main">
									<div class="alert alert-info">Lorem ipsum dolor sit
					...
					<div class="col-xs-12 col-sm-6 widget-container-col"
						...
						<div class="widget-box widget-color-dark" id="widget-box-8">
							<div class="widget-header">
								...
								<div class="widget-toolbar">
									<label> <input type="checkbox"
										class="ace ace-checkbox-2" id="id-checkbox-vertical" /> <span
										class="lbl middle padding-4"> Vertical</span>
									</label>
								</div>

								<div class="widget-toolbar">
									<div
										class="progress progress-mini progress-striped active pos-rel"
										style="width: 60px;" data-percent="61%">
							...
							<div class="widget-body">
									...
									<div class="btn-toolbar">
										...
										<div data-toggle="buttons" class="btn-group">
											<label class="btn btn-sm btn-default btn-white btn-round">
												<i class="icon-only ace-icon fa fa-bold bigger-110"></i> <input
								...
								<div class="widget-main padding-16">Lorem ipsum dolor sit
									...
									consectetur. Etiam justo nisl, gravida id egestas eu, eleifend
									vel metus. Pellentesque tellus ipsum, euismod in facilisis
									quis, aliquet quis sem.</div>
							</div>
						</div>
					</div>
							...
							<div class="widget-header">
								...
								<div class="widget-toolbar no-border">
									...
									<button class="btn btn-xs bigger btn-yellow dropdown-toggle"
										...
										Next <i class="ace-icon fa fa-chevron-down icon-on-right"></i>
									</button>
							...
							<div class="widget-body">
								...
								<div class="widget-toolbox padding-8 clearfix">
									<button class="btn btn-xs btn-danger pull-left">
										<i class="ace-icon fa fa-times"></i> <span class="bigger-110">I
											don't accept</span>
									</button>
						...
						<div class="widget-box transparent" id="widget-box-12">
							...
							<div class="widget-body">
								<div
									...
									dignissim volutpat justo non consectetur.</div>
							</div>
						</div>
					</div>
